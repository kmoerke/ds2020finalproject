...
This is the fullset, it is too big for github and to analyze, so I restrict it to only include Iowa and write it to another csv later.
```{r}
...
correlations <- sapply(relevant, function(x) cor(x, iowa_df$NatWalkInd, use = "complete.obs"))
